...
SUITE_INFO = '<div style=" width: 800px;">'
    ...
    + '<br><br>'
    + '<h3>PATHiPRED</h3>'
    + '<p align="justify">The aim of PATHiPRED web tool is to provide subpathway-level information useful to distinguish between two classes. PATHiPRED uses the probability of activation of stimulus-response subpathways obtained with PATHiWAYS methodology to compute a predictor that discriminates between two conditions. PATHiPRED performs a correlation-based feature selection followed by a SVM modelling with cross-validation. PATHiPRED results include the subpathways that best differentiate between two classes, the confusion matrix of the prediction, statistical parameters that assess the goodness of the model and pathways graphs with the selected subpathways highlighted.</p>'
    + '<br><br><br>'
